  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-8 space-y-8">
      <div className="w-full text-center mb-12">
        <h2 className="text-3xl font-bold">Démonstration de SparklesCore</h2>
        <p className="text-gray-500 mt-2">Exemples d'utilisations du composant de particules</p>
      </div>

      <div className="space-y-16">
        <div>
          <h3 className="text-xl font-bold mb-4">Exemple 1: Basique</h3>
          <SparklesPreview />
        </div>

        <div>
          <h3 className="text-xl font-bold mb-4">Exemple 2: Fond sombre</h3>
          <SparklesPreviewDark />
        </div>

        <div>
          <h3 className="text-xl font-bold mb-4">Exemple 3: Coloré</h3>
